...
compton vim vim-gtk pcmanfm arandr lxappearance htop ranger tmux qt5ct feh firefox-esr alsa-utils network-manager dunst locate zathura sxiv scrot"
...
# Fonts
git clone https://github.com/powerline/fonts /tmp/ && sh /tmp/install.sh
rm -rfv /tmp/fonts
